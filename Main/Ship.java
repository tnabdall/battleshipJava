 ...
 * To be placed on Main.GameBoard using PlaceShip.
 */
public class Ship{
     ...
     * @param name Main.Ship's name.
     * @param length Main.Ship's length
     */
	...
	*/
     ...
     * @param index Main.Ship's index. Index 0 is first coordinate placed. Length - 1 is other end of ship.
     */
     ...
     *
     * @param index Index of Main.Ship coordinates
